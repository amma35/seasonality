...
DROP TABLE IF EXISTS `glpi_plugin_seasonality_configs`;
CREATE TABLE `glpi_plugin_seasonality_configs` (
	`id` int(11) NOT NULL auto_increment,
	`config` tinyint(1) NOT NULL default '0',
	PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
INSERT INTO `glpi_plugin_seasonality_configs` (`id`,`config`) VALUES ('1', '0');

DROP TABLE IF EXISTS `glpi_plugin_seasonality_sensibilities`;
CREATE TABLE `glpi_plugin_seasonality_sensibilities` (
	`id` int(11) NOT NULL auto_increment,
